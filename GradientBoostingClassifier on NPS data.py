You can improved the PolkaDot solution and reach an accuracy of around 86% with a simple Gradient Boosting by using the sklearn library.
 That would come up to something like this:
